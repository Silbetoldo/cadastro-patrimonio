...
// Objeto contendo todos os estilos utilizados na página de Login.
// Facilita a organização visual e mantém o código mais limpo.
export const loginStyles = {

  // Estilo base da página — ocupa toda a altura da tela
  page: "min-h-screen flex flex-col bg-slate-50",

  // Área central onde o card de login aparece
  main: "flex-1 flex items-center justify-center px-4 py-8",

  // Estilo do card que contém o formulário de login
  card:
  ...
  // Área onde ficam os botões de "Entrar" e "Limpar"
